...
const hammerTools = new Tools();
console.log(hammerTools.name)
...
**在子类中重写constructor函数，必须调用spuer()，确保继承的正常**
...
abstract class Animal{
  //abstract开头 抽象方法只能定义在抽象类里，并且没有方法体，子类必须对抽象方法进行重写
  abstract run(): void;
  bark(){
      console.log('动物在叫~');
  }
